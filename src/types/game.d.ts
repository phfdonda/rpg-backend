...
interface AcaoCombate {
  tipo: 'acao_combate'
  acao: 'ataque' | 'defender' | 'fugir' | 'habilidade_especial' | 'conjurar_magia'
...
interface FichaLocal {
  id: string
  nome: string
  tipo_local: 'masmorra' | 'cidade' | 'floresta' | 'taverna' | 'ruina' | 'forte' | 'passagem'
...
interface EventoComContagemRegressiva {
  ...
  consequencia_final: AcaoDoJogo | AcaoDoJogo[] | { tipo: 'narrativa'; descricao: string } // Pode ser uma ação direta ou apenas algo para o Narrador
